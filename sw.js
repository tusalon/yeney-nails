...
const urlsToCache = [
  ...
  '/yeney-nails/vendor/react.production.min.js',
  '/yeney-nails/vendor/react-dom.production.min.js',
  '/yeney-nails/vendor/babel.min.js',
  '/yeney-nails/vendor/bcrypt.min.js',
  '/yeney-nails/vendor/tailwind-browser.js',
  '/yeney-nails/vendor/lucide/lucide.css',
  '/yeney-nails/vendor/lucide/lucide.woff2',
  '/yeney-nails/utils/push-config.js',
  '/yeney-nails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/yeney-nails/icons/icon-192x192.png',
    badge: '/yeney-nails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/yeney-nails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/yeney-nails/admin.html';
  event.waitUntil(
